...
inline static float matRead(Mat mat, u32 x, u32 y) {
  return mat.data[x * mat.c + y];
}

inline static void matWrite(Mat mat, u32 x, u32 y, float val) {
  mat.data[x * mat.c + y] = val;
}

inline static float *matView(Mat mat, u32 x, u32 y) {
  return &mat.data[x * mat.c + y];
}
